...
input_folder = '/Users/stonn/Documents/trypan_blue/ROI-tiles-selection/hyphae_resorted/'

# the different folders into which you want to sort the images, e.g. ['cars', 'bikes', 'cats', 'horses', 'shoes']
labels = ["hyphae", "no_hyphae"]
...
# Not sure what the code block below is supposed to do but it throws an error, and the script works without it
# =============================================================================
#         else: #deal with heic
